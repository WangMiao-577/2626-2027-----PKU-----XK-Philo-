...
\subsection{逐像素处理Pixel(Point) Processing}

\subsubsection{基本P图操作}
...
\paragraph{Joint Bilaterial Filter}
...
\subsection{UpSampling \& DownSmapling}

\subsubsection{DownSampling和防走样}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{/home/simson/图片/截图/截图 2026-09-17 11-55-56.png}
\end{figure}
